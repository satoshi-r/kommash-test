...
<header class="header green-header">
    <div class="header-bg" style="display: block;"></div>
...
<div class="page404_wrapper">
    <div class="page404_wrap">
        <div class="page404_text">
            <div class="page404_text_title">404</div>
            <div class="page404_text_subtitle">
                Страница не найдена
            </div>
            <div class="page404_text_desc">
                Перейдите <a href="/" class="link_splash">на главную</a> или <a href="/products/graz/" class="link_splash">в каталог</a>
            </div>
        </div>
