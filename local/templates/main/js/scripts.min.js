...
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var r=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");r(document).ready((function(){r(".header-menu__btn").hover((function(){r(this).find(".header-menu__dropdown").fadeToggle(200)})),r("#hamburger-btn").click((function(){r(this).toggleClass("menu-open"),r(this).hasClass("menu-open")&&r(".hamburger").fadeIn(200).delay(150)}));const e=r(".header-search");r("#search-open").click((function(){e.fadeIn(300).css("display","flex")})),r("#search-close").click((function(){e.fadeOut(300)})),addEventListener("keydown",(function(t){27==t.keyCode&&(t.stopPropagation(),e.fadeOut(300))}))}))},"./js/index.js":
/*!*********************!*\
  !*** ./js/index.js ***!
  \*********************/
