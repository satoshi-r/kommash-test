...
/*!********************!*\
  !*** ./js/form.js ***!
  \********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");document.addEventListener("DOMContentLoaded",(function(){function e(e){var t=0,n="+7 (___) ___ ____".replace(/\D/g,""),i=this.value.replace(/\D/g,"");n.length>=i.length&&(i=n),this.value="+7 (___) ___ ____".replace(/./g,(function(e){return/[_\d]/.test(e)&&t<i.length?i.charAt(t++):t>=i.length?"":e})),"blur"==e.type?2==this.value.length&&(this.value=""):function(e,t){if(t.focus(),t.setSelectionRange)t.setSelectionRange(e,e);else if(t.createTextRange){var n=t.createTextRange();n.collapse(!0),n.moveEnd("character",e),n.moveStart("character",e),n.select()}}(this.value.length,this)}var t=document.querySelector('input[type="tel"]');t.addEventListener("input",e,!1),t.addEventListener("focus",e,!1),t.addEventListener("blur",e,!1)})),i(document).ready((function(){const e=i(".test-drive form"),t=i(".test-drive-success");function n(e){i(e).removeClass("form_error"),i(e).addClass("form_accepted")}function o(e,t){i(e).removeClass("form_accepted"),i(e).addClass("form_error"),i(".error_message").text(t)}function r(e){const t=i(e).closest(".input"),r=i(e).val().length;return 17==r?(n(t),!0):r<17&&0!==r?(o(t,"Это поле заполнено неверно"),!1):0==r?(o(t,"Это поле нужно заполнить"),!1):void 0}function s(e){const t=i(e).val().search(/^[a-z0-9_-]+@[a-z0-9-]+\.([a-z]{1,6}\.)?[a-z]{2,6}$/i),r=i(e).closest(".input"),s=i(e).val().length;return 0==t?(n(r),!0):-1==t&&0!==s?(o(r,"Это поле заполнено неверно"),!1):(o(r,"Это поле нужно заполнить"),!1)}e.find('input:not([type="text"])').each((function(e,t){const n="tel"==i(t).attr("type"),o="email"==i(t).attr("type");i(t).on("blur",(function(){n?r(t):o&&s(t)}))})),e.on("submit",(function(n){if(n.preventDefault(),s(i("#td_email"))&&r(i("#td_tel"))){const n=i("#td_name").val().trim(),o=i("#td_tel").val().trim(),r=i("#td_email").val().trim(),s=i("#td_comment").val().trim(),a=i(this).attr("action");i.ajax({url:a,type:"POST",cache:!1,data:{name:n,email:r,tel:o,comment:s},dataType:"html",success:function(n){console.log(n),e.fadeOut(300,(function(){t.fadeIn(300).css("display","flex")})),setTimeout(()=>{t.fadeOut(300,(function(){e.fadeIn(300)}))},4e3)}})}}))}))},"./js/header.js":
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
