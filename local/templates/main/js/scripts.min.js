...
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var r=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");r(document).ready((function(){r(".header-menu__btn").hover((function(){r(this).find(".header-menu__dropdown").fadeToggle(200)}));const e=r(".hamburger");r("#hamburger-btn").click((function(){r(this).toggleClass("menu-open"),r(this).hasClass("menu-open")?e.delay(150).fadeIn(200).addClass("hamburger-opened"):e.fadeOut(200).removeClass("hamburger-opened")}));const t=r(".header-search");r("#search-open").click((function(){t.fadeIn(300).css("display","flex")})),r("#search-close").click((function(){t.fadeOut(300)})),r(document).on("keydown",(function(e){27==e.keyCode&&(e.stopPropagation(),t.fadeOut(300))})),r(".hamburger-accordeon").on("click",(function(e){e.preventDefault(),r(this).closest(".accordeon-item").hasClass("accordeon-open")?r(".accordeon-item").removeClass("accordeon-open"):(r(".accordeon-item").removeClass("accordeon-open"),r(this).closest(".accordeon-item").addClass("accordeon-open"));const t=r(this).next();t.slideToggle(100),r(".accordeon-item .hamburger-accordeon__list").not(t).slideUp("fast")}))}))},"./js/index.js":
/*!*********************!*\
  !*** ./js/index.js ***!
  \*********************/
