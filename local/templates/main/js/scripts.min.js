...
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");i(document).ready((function(){i(".header-menu__btn").hover((function(){i(this).find(".header-menu__dropdown").fadeToggle(200)})),i(window).scroll((function(e){e.scrollTop>0?i(".header-bg").show(300):i(".header-bg").hide(300)}));const e=i(".hamburger");i("#hamburger-btn").click((function(){i(this).toggleClass("menu-open"),i(this).hasClass("menu-open")?e.delay(150).fadeIn(200).addClass("hamburger-opened"):e.fadeOut(200).removeClass("hamburger-opened")})),i(".hamburger-accordeon").on("click",(function(e){e.preventDefault(),i(this).closest(".accordeon-item").hasClass("accordeon-open")?i(".accordeon-item").removeClass("accordeon-open"):(i(".accordeon-item").removeClass("accordeon-open"),i(this).closest(".accordeon-item").addClass("accordeon-open"));const t=i(this).next();t.slideToggle(100),i(".accordeon-item .hamburger-accordeon__list").not(t).slideUp("fast")}));const t=i(".contacts");i(".header-contacts__btn").click((function(){t.addClass("opened")}));i(document).mouseup((function(e){(e=>{t.is(e.target)||0!==t.has(e.target).length||t.removeClass("opened")})(e)}));const n=i(".header-search");i("#search-open").click((function(){n.fadeIn(300).css("display","flex")})),i("#search-close").click((function(){n.fadeOut(300)})),i(document).on("keydown",(function(e){27==e.keyCode&&(e.stopPropagation(),n.fadeOut(300))}))}))},"./js/index.js":
/*!*********************!*\
  !*** ./js/index.js ***!
  \*********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);n(/*! ./header.js */"./js/header.js"),n(/*! ./first-slider */"./js/first-slider.js");document.addEventListener("DOMContentLoaded",()=>{let e;window.addEventListener("resize",()=>{document.body.classList.add("resize-animation-stopper"),clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("resize-animation-stopper")},400)})})},"./node_modules/jquery/dist/jquery.js":
/*!********************************************!*\
