...
/*!*********************!*\
  !*** ./js/index.js ***!
  \*********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);n(/*! ./header */"./js/header.js"),n(/*! ./first-slider */"./js/first-slider.js"),n(/*! ./animations */"./js/animations.js"),n(/*! ./test-drive */"./js/test-drive.js");var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");document.addEventListener("DOMContentLoaded",()=>{let e;window.addEventListener("resize",()=>{document.body.classList.add("resize-animation-stopper"),clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("resize-animation-stopper")},400)}),i("img, a").on("dragstart",(function(e){e.preventDefault()}))})},"./js/test-drive.js":
/*!**************************!*\
  !*** ./js/test-drive.js ***!
  \**************************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");document.addEventListener("DOMContentLoaded",(function(){function e(e){var t=0,n="+7 (___) ___ ____".replace(/\D/g,""),i=this.value.replace(/\D/g,"");n.length>=i.length&&(i=n),this.value="+7 (___) ___ ____".replace(/./g,(function(e){return/[_\d]/.test(e)&&t<i.length?i.charAt(t++):t>=i.length?"":e})),"blur"==e.type?2==this.value.length&&(this.value=""):function(e,t){if(t.focus(),t.setSelectionRange)t.setSelectionRange(e,e);else if(t.createTextRange){var n=t.createTextRange();n.collapse(!0),n.moveEnd("character",e),n.moveStart("character",e),n.select()}}(this.value.length,this)}var t=document.querySelector('input[type="tel"]');t.addEventListener("input",e,!1),t.addEventListener("focus",e,!1),t.addEventListener("blur",e,!1)})),i(document).ready((function(){function e(e){i(e).removeClass("form_error"),i(e).addClass("form_accepted")}function t(e,t){i(e).removeClass("form_accepted"),i(e).addClass("form_error"),i(".error_message").text(t)}i(".test-drive form").find('input:not([type="text"])').each((function(n,o){var r="tel"==i(o).attr("type"),s="email"==i(o).attr("type");i(o).on("blur",(function(){var n,a,l;r?(a=i(n=o).closest(".input"),17==(l=i(n).val().length)?e(a):l<17&&0!==l?t(a,"Это поле заполнено неверно"):0==l&&t(a,"Это поле нужно заполнить")):s&&function(n){var o=i(n).val().search(/^[a-z0-9_-]+@[a-z0-9-]+\.([a-z]{1,6}\.)?[a-z]{2,6}$/i),r=i(n).closest(".input"),s=i(n).val().length;0==o?e(r):t(r,-1==o&&0!==s?"Это поле заполнено неверно":"Это поле нужно заполнить")}(o)}))}))}))},"./node_modules/jquery/dist/jquery.js":
/*!********************************************!*\
