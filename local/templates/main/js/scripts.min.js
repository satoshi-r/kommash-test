...
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var r=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");r(document).ready((function(){r(".header-menu__btn").hover((function(){r(this).find(".header-menu__dropdown").fadeToggle(200)}));const e=r(".hamburger");r("#hamburger-btn").click((function(){r(this).toggleClass("menu-open"),r(this).hasClass("menu-open")?e.delay(150).fadeIn(200).addClass("hamburger-opened"):e.fadeOut(200).removeClass("hamburger-opened")})),r(".hamburger-accordeon").on("click",(function(e){e.preventDefault(),r(this).closest(".accordeon-item").hasClass("accordeon-open")?r(".accordeon-item").removeClass("accordeon-open"):(r(".accordeon-item").removeClass("accordeon-open"),r(this).closest(".accordeon-item").addClass("accordeon-open"));const t=r(this).next();t.slideToggle(100),r(".accordeon-item .hamburger-accordeon__list").not(t).slideUp("fast")}));const t=r(".contacts");r(".header-contacts__btn").click((function(){t.addClass("opened")}));r(document).mouseup((function(e){(e=>{t.is(e.target)||0!==t.has(e.target).length||t.removeClass("opened")})(e)}));const n=r(".header-search");r("#search-open").click((function(){n.fadeIn(300).css("display","flex")})),r("#search-close").click((function(){n.fadeOut(300)})),r(document).on("keydown",(function(e){27==e.keyCode&&(e.stopPropagation(),n.fadeOut(300))}))}))},"./js/index.js":
/*!*********************!*\
  !*** ./js/index.js ***!
  \*********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);n(/*! ./header.js */"./js/header.js");document.addEventListener("DOMContentLoaded",()=>{let e;window.addEventListener("resize",()=>{document.body.classList.add("resize-animation-stopper"),clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("resize-animation-stopper")},400)})})},"./node_modules/jquery/dist/jquery.js":
/*!********************************************!*\
