...
/*!***********************!*\
  !*** ./js/catalog.js ***!
  \***********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");i(document).ready((function(){const e=i(".catalog-output");i(".catalog-view form").on("change",(function(t){const n=t.target.id;e.fadeOut(200,(function(){e.removeClass((function(e,t){return t.split(" ").filter((function(e){return-1==="catalog-output".indexOf(e)})).join(" ")})),e.addClass(n)})),e.delay(200).fadeIn(200)}));const t=i(".catalog-description__btn"),n=i(".catalog-description__text"),o=n.height();n.css({"max-height":"200px",overflow:"hidden"}),t.click((function(){n.toggleClass("show"),n.hasClass("show")?(n.animate({"max-height":o},200),t.text("Свернуть")):(n.animate({"max-height":"200px"},200),t.text("Подробнее"))})),i("#filter-clear").click((function(){i('.catalog-filter input[type="checkbox"').prop("checked",!1)}))}))},"./js/first-slider.js":
/*!****************************!*\
  !*** ./js/first-slider.js ***!
  \****************************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");n(/*! slick-carousel */"./node_modules/slick-carousel/slick/slick.js");i(".first .slider").slick({slidesToShow:1,slidesToScroll:1,draggable:!1,arrows:!1,dots:!1,fade:!0}),i(".slider-dots").slick({slidesToShow:3,slidesToScroll:3,asNavFor:".first .slider",dots:!1,arrows:!1,centerMode:!0,focusOnSelect:!0,centerPadding:"0"}),i(".first .slider .slider-item").parent().css("height","100%")},"./js/forms.js":
/*!*********************!*\
  !*** ./js/forms.js ***!
  \*********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");document.addEventListener("DOMContentLoaded",(function(){function e(e){let t=0,n="+7 (___) ___ ____".replace(/\D/g,""),i=this.value.replace(/\D/g,"");n.length>=i.length&&(i=n),this.value="+7 (___) ___ ____".replace(/./g,(function(e){return/[_\d]/.test(e)&&t<i.length?i.charAt(t++):t>=i.length?"":e})),"blur"==e.type?2==this.value.length&&(this.value=""):function(e,t){if(t.focus(),t.setSelectionRange)t.setSelectionRange(e,e);else if(t.createTextRange){const n=t.createTextRange();n.collapse(!0),n.moveEnd("character",e),n.moveStart("character",e),n.select()}}(this.value.length,this)}const t=document.querySelector('input[type="tel"]');t.addEventListener("input",e,!1),t.addEventListener("focus",e,!1),t.addEventListener("blur",e,!1)})),i(document).ready((function(){const e=e=>{i(e).removeClass("form_error"),i(e).addClass("form_accepted")},t=(e,t)=>{i(e).removeClass("form_accepted"),i(e).addClass("form_error"),i(e).find(".error_message").text(t)},n=n=>{const o=i(n).closest(".input"),r=i(n).val().length;return 17==r?(e(o),!0):r<17&&0!==r?(t(o,"Это поле заполнено неверно"),!1):0==r?(t(o,"Это поле нужно заполнить"),!1):void 0},o=n=>{const o=i(n).val().search(/^[a-z0-9_-]+@[a-z0-9-]+\.([a-z]{1,6}\.)?[a-z]{2,6}$/i),r=i(n).closest(".input"),s=i(n).val().length;return 0==o?(e(r),!0):-1==o&&0!==s?(t(r,"Это поле заполнено неверно"),!1):(t(r,"Это поле нужно заполнить"),!1)},r=n=>{const o=i(n).closest(".input");return 0!==i(n).val().length?(e(o),!0):(t(o,"Это поле нужно заполнить"),!1)},s=i(".test-drive form"),a=i(".test-drive-success");s.find('input:not([type="text"])').each((function(e,t){const r="tel"==i(t).attr("type"),s="email"==i(t).attr("type");i(t).on("blur",(function(){r?n(t):s&&o(t)}))})),s.on("submit",(function(e){if(e.preventDefault(),o(i("#td_email"))&&n(i("#td_tel"))){const e=i("#td_name").val().trim(),t=i("#td_tel").val().trim(),n=i("#td_email").val().trim(),o=i("#td_comment").val().trim(),r=i(this).attr("action");i.ajax({url:r,type:"POST",cache:!1,data:{name:e,email:n,tel:t,comment:o},dataType:"html",success:function(e){console.log(e),s.fadeOut(300,(function(){a.fadeIn(300).css("display","flex")})),setTimeout(()=>{a.fadeOut(300,(function(){s.fadeIn(300)}))},4e3)}})}}));const l=i("#product-modal form"),c=i("#product-modal .product-modal-success");l.find("input:not(#p_name)").each((function(e,t){const s="tel"==i(t).attr("type"),a="email"==i(t).attr("type"),l="text"==i(t).attr("type");i(t).on("blur",(function(){s?n(t):a?o(t):l&&r(t)}))})),l.on("submit",(function(e){if(e.preventDefault(),o(i("#p_email"))&&n(i("#p_tel"))&&r(i("#p_company"))&&r(i("#p_region"))){const e=i("#p_name").val().trim(),t=i("#p_tel").val().trim(),n=i("#p_email").val().trim(),o=i("#p_company").val().trim(),r=i("#p_region").val().trim(),s=i(this).attr("action");i.ajax({url:s,type:"POST",cache:!1,data:{name:e,email:n,tel:t,company:o,region:r},dataType:"html",success:function(e){console.log(e),l.fadeOut(300,(function(){c.fadeIn(300).css("display","flex")})),setTimeout(()=>{c.fadeOut(300,(function(){l.fadeIn(300)}))},4e3)}})}}))}))},"./js/header.js":
/*!**********************!*\
  !*** ./js/header.js ***!
  \**********************/
